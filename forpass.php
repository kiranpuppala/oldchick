...
$mail->Body = "Your Old Chick new password is $randnum";
...
$query2="UPDATE candidates SET password=SHA('$randnum') WHERE emailaddr='$toemail'";
$result2=mysqli_query($dbc,$query2) or die ('error resetting');
