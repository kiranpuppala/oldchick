...
mysqli_close($dbc);
$home_url = 'http://' . $_SERVER['HTTP_HOST'] . dirname($_SERVER['PHP_SELF']) . '/salesuccess.php';
...
<li style="visibility:hidden">Hidden field for space only for space some sme some </li>
  ...
  <li><a class="inbox" style="color:yellow" href="sellitem.php"><img src="images/tag.png" width="19.18px" height="14px" > Sellitem</a></li>
...
<div class="edit_prof">
<p style="font-weight:bold;opacity:.6"><b>Place sale</b></p>
<hr>
<form  enctype="multipart/form-data" method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>"  onsubmit="return validateForm()" >


<input id="itemname" value="<?php if(!empty($itemname)) echo $itemname;?>" placeholder="Item name" type="text" name="itemname"> <br><div id="citemname"></div><br>
...
<option value="mo">Mobiles</option>
<option value="eg">Electronic gadgets</option>
<option value="sp">Sports</option>
<option value="ot">Others</option>
</select><br><br><div id="ccategory"></div><br>


<input id="price"  value="<?php if(!empty($price)) echo $price;?>" placeholder="Price" type="text" name="price" ><br><div id="cprice"></div><br>


<label for="primage" style="font-weight:bold;opacity:.6">Upload image file</label>
